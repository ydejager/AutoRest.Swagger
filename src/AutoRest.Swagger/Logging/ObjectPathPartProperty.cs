...
namespace AutoRest.Swagger.Logging
{
    public class ObjectPathPartProperty : ObjectPathPart
    {
        ...
        private static readonly Regex regexValidES3DotNotationPropertyName = new Regex(
        ...
        public override string JsonPath => regexValidES3DotNotationPropertyName.IsMatch(Property)
            ? $".{Property}"
