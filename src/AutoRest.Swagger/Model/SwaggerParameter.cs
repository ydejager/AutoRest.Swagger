...
namespace AutoRest.Swagger.Model
{
    ...
    public class SwaggerParameter : SwaggerObject
    {
        ...
        {
            get => _isRequired || In == ParameterLocation.Path;
            set => _isRequired = value;
        }

        [JsonIgnore] public bool IsConstant => IsRequired && Enum != null && Enum.Count == 1;
        ...
        public override IEnumerable<ComparisonMessage> Compare(ComparisonContext context, SwaggerBase previous)
        {
            ...
            if (priorParameter == null) throw new ArgumentNullException("priorVersion");
            ...
            if (In != priorParameter.In)
                context.LogBreakingChange(ComparisonMessages.ParameterInHasChanged,
                    priorParameter.In.ToString().ToLower(), In.ToString().ToLower());
            ...
            if (Schema != null && priorParameter.Schema != null) Schema.Compare(context, priorParameter.Schema);
