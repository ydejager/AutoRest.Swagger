...
namespace AutoRest.Swagger.Model
{
    ...
    public abstract class SwaggerObject : SwaggerBase
    {
        ...
        public override IEnumerable<ComparisonMessage> Compare(ComparisonContext context, SwaggerBase previous)
        {
            ...
            if (prior == null) throw new ArgumentNullException("priorVersion");
            ...
            if (IsRequired != prior.IsRequired)
                ...
                {
                    if (IsRequired && !prior.IsRequired)
                        context.LogBreakingChange(ComparisonMessages.RequiredStatusChange, prior.IsRequired,
                            IsRequired);
                    else
            ...
            if (Default != null && !Default.Equals(prior.Default) ||
                Default == null && !string.IsNullOrEmpty(prior.Default))
        ...
        {
            if (prior.Enum == null && Enum == null) return;
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification =
            "It may look complex, but it really isn't.")]
